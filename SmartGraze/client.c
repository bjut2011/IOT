...
int main()
{
    ...
    char *str="#MG$a00E1:A,BH20160200001;C,+8613800138000;D,+8613800138000,+8610086,+8610001;E,10010F0C1E0F;F,0D4C230A,N,43AE5A68,E;G,460,00,2493,13cf,47,2493,1268,42,2493,14d5,36;H,50,1F4,2,Y;I,2A3C,CD07,32,1F,10,3;J,Y,N,N,N;K,200;*1D";
    int len=strlen(str);
